...
<body>
    ...
    <div align="center" class="viewZapatos">
        ...
        <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../Imagenes/ZapatosNinos/Smartfit.jpg" alt="modelo1" class="d-block" style="width:40%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/ZapatosNinos/smartfit1.1.png" alt="modelo2" class="d-block" style="width:45%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/ZapatosNinos/smartfit1.2.jpg" alt="modelo3" class="d-block" style="width:40%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/ZapatosNinos/smartfit1.3.jpg" alt="modelo4" class="d-block" style="width:40%">
                </div>
            </div>
        ...
        <div class="formato-preCompra">
                    <p class="h3">Smartfit</p>
                    <p class="fs-5">Precio Q.399.99</p>
                </div>
        <form method="get">
            ...
            <div class="btnDatos2">
                <input type="image" src="../Imagenes/carritoIcono.png" style="border:none;" name="btnCarrito"
                    height="90" width="80" />
            </div>
        </form>
    </div>
