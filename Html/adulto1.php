        ...
        <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../Imagenes/zapatosAdultos/1.jpeg" alt="modelo1" class="d-block" style="width:70%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/zapatosAdultos/1.1.jpg" alt="modelo2" class="d-block" style="width:70%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/zapatosAdultos/1.2.jpg" alt="modelo3" class="d-block" style="width:70%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/zapatosAdultos/1.3.jpg" alt="modelo4" class="d-block" style="width:70%">
                </div>
            </div>
