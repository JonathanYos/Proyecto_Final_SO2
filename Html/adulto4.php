        ...
        <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../Imagenes/zapatosAdultos/4.jpg" alt="modelo1" class="d-block" style="width:80%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/zapatosAdultos/4.1.jpg" alt="modelo2" class="d-block" style="width:70%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/zapatosAdultos/4.2.jpg" alt="modelo3" class="d-block" style="width:40%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/zapatosAdultos/4.3.jpg" alt="modelo4" class="d-block" style="width:80%">
                </div>
            </div>
        ...
        <form method="get">
            ...
            <div class="btnDatos2">
                <input type="image" src="../Imagenes/carritoIcono.png" style="border:none;" name="btnCarrito"
                    id="btnCarrito" height="90" width="80" />
            </div>
        </form>
    </div>
