        ...
        <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../Imagenes/zapatosAdultos/2.jpg" alt="modelo1" class="d-block" style="width:57%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/zapatosAdultos/2.1.jpg" alt="modelo2" class="d-block" style="width:40%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/zapatosAdultos/2.2.jpg" alt="modelo3" class="d-block" style="width:65%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/zapatosAdultos/2.3.jpg" alt="modelo4" class="d-block" style="width:65%">
                </div>
            </div>
