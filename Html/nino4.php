        ...
        <div id="demo" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../Imagenes/ZapatosNinos/VertekRun.jpg" alt="modelo1" class="d-block" style="width:38%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/ZapatosNinos/vertekRun1.1.jpg" alt="modelo2" class="d-block"
                        style="width:38%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/ZapatosNinos/vertekRun1.2.jpg" alt="modelo3" class="d-block"
                        style="width:38%">
                </div>
                <div class="carousel-item">
                    <img src="../Imagenes/ZapatosNinos/vertekRun1.3.jpg" alt="modelo4" class="d-block"
                        style="width:38%">
                </div>
            </div>
